...
namespace GameEstate.Toy.Core
{
    ...
    {
        //static readonly Dictionary<string, Package> CachedPackages = new Dictionary<string, Package>();
        //readonly Dictionary<string, Resource> CachedResources = new Dictionary<string, Resource>();
        ...
        public object LoadFileByAnyMeansNecessary(string file, GuiContext guiContext)
        {
        ...
        //        static string FindResourcePath(IList<string> paths, string file, string currentFullPath = null)
        //        {
