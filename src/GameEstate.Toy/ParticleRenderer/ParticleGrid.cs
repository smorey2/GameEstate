...
{
    public class ParticleGrid : IRenderer
    {
        readonly int _vao;
        ...
        public ParticleGrid(float cellWidth, int gridWidthInCells, GuiContext guiContext)
        {
            ...
            _shader = guiContext.ShaderLoader.LoadShader("vrf.grid", new Dictionary<string, bool>());
