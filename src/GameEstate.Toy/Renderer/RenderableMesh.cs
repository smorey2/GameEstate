...
namespace GameEstate.Toy.Renderer
{
    ...
    public class RenderableMesh
    {
        ...
        public RenderableMesh(Mesh mesh, GuiContext guiContext, Dictionary<string, string> skinMaterials = null)
        {
        ...
        DrawCall CreateDrawCall(Dictionary<string, object> objectDrawCall, VBIB vbib, IDictionary<string, bool> shaderArguments, RenderMaterial material)
        {
