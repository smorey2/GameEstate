...
namespace GameEstate.Formats.AC.Props
{
    ...
    partial class EnumExtensions
    {
        ...
        public static PropertyAttribute GetAttribute(this AugmentationType type)
        {
            switch (type)
            {
                case AugmentationType.Strength: return PropertyAttribute.Strength;
                case AugmentationType.Endurance: return PropertyAttribute.Endurance;
                case AugmentationType.Coordination: return PropertyAttribute.Coordination;
                case AugmentationType.Quickness: return PropertyAttribute.Quickness;
                case AugmentationType.Focus: return PropertyAttribute.Focus;
                case AugmentationType.Self: return PropertyAttribute.Self;
                default: return PropertyAttribute.Undef;
            }
        }
        ...
        public static Skill GetSkill(this AugmentationType type)
        {
            switch (type)
            {
                case AugmentationType.Salvage: return Skill.Salvaging;
                case AugmentationType.ItemTinkering: return Skill.ItemTinkering;
                case AugmentationType.ArmorTinkering: return Skill.ArmorTinkering;
                case AugmentationType.MagicItemTinkering: return Skill.MagicItemTinkering;
                case AugmentationType.WeaponTinkering: return Skill.WeaponTinkering;
    ...
    partial class EnumExtensions
    {
        ...
        public static float GetAimAngle(this MotionCommand motion)
        {
            switch (motion)
            {
                case MotionCommand.AimHigh15: return 15.0f;
                case MotionCommand.AimHigh30: return 30.0f;
                case MotionCommand.AimHigh45: return 45.0f;
                case MotionCommand.AimHigh60: return 60.0f;
                case MotionCommand.AimHigh75: return 75.0f;
                case MotionCommand.AimHigh90: return 90.0f;
                case MotionCommand.AimLow15: return -15.0f;
                case MotionCommand.AimLow30: return -30.0f;
                case MotionCommand.AimLow45: return -45.0f;
                case MotionCommand.AimLow60: return -60.0f;
                case MotionCommand.AimLow75: return -75.0f;
                case MotionCommand.AimLow90: return -90.0f;
                default: return 0.0f;
            }
        }
    }
    ...
    partial class EnumExtensions
    {
        ...
        public static Quadrant ToQuadrant(this QuadrantIndex idx)
        {
            switch (idx)
            {
                case QuadrantIndex.HLF: return HLF;
                case QuadrantIndex.MLF: return MLF;
                case QuadrantIndex.LLF: return LLF;
                case QuadrantIndex.HRF: return HRF;
                case QuadrantIndex.MRF: return MRF;
                case QuadrantIndex.LRF: return LRF;
                case QuadrantIndex.HLB: return HLB;
                case QuadrantIndex.MLB: return MLB;
                case QuadrantIndex.LLB: return LLB;
                case QuadrantIndex.HRB: return HRB;
                case QuadrantIndex.MRB: return MRB;
                case QuadrantIndex.LRB: return LRB;
                default: return Quadrant.None;
            }
        }
        ...
        public static QuadrantIndex GetIndex(this Quadrant quadrant)
        {
            switch (quadrant)
            {
                case HLF: return QuadrantIndex.HLF;
                case MLF: return QuadrantIndex.MLF;
                case LLF: return QuadrantIndex.LLF;
                case HRF: return QuadrantIndex.HRF;
                case MRF: return QuadrantIndex.MRF;
                case LRF: return QuadrantIndex.LRF;
                case HLB: return QuadrantIndex.HLB;
                case MLB: return QuadrantIndex.MLB;
                case LLB: return QuadrantIndex.LLB;
                case HRB: return QuadrantIndex.HRB;
                case MRB: return QuadrantIndex.MRB;
                case LRB: return QuadrantIndex.LRB;
                default: return 0;
            }
        }
    }
