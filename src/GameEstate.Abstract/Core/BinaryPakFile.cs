...
namespace GameEstate.Core
{
    ...
    public abstract class BinaryPakFile : AbstractPakFile
    {
        ...
        /// <param name="exception">The exception.</param>
        /// <returns></returns>
        public virtual Task<Stream> ReadFileDataAsync(BinaryReader r, FileMetadata file, Action<FileMetadata, string> exception) => PakBinary.ReadFileAsync(this, r, file, exception);
        ...
        /// <param name="exception">The exception.</param>
        /// <returns></returns>
        public virtual Task WriteFileDataAsync(BinaryWriter w, FileMetadata file, Stream data, Action<FileMetadata, string> exception) => PakBinary.WriteFileAsync(this, w, file, data, exception);
