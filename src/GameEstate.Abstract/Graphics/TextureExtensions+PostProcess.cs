...
namespace GameEstate.Graphics
{
    ...
    static partial class TextureExtensions
    {
        ...
        {
            Assert(source.Width > 0 && source.Height > 0 && source.BytesPerPixel > 0 && source.Mipmaps > 0 && source.Data != null);
            ...
            while (mipMapLevelWidth > 1 || mipMapLevelHeight > 1)
            {
                ...
                if (flipVertically && mipMapLevelIndex < mipmaps)
