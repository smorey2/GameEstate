...
{
    public static class PakFormat01
    {
        public static void Read(CorePakFile source, BinaryReader r, byte[] magic)
        {
        ...
        public static void Write(CorePakFile source, BinaryWriter w, byte[] magic) => throw new NotSupportedException();
    }
}