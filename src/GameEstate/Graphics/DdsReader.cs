...
//    [Flags]
//    public enum DDSPixelFormats : uint 
//    {
...
//        /// </summary>
//        public static TextureInfo LoadDDSTexture(string filePath, bool flipVertically = false) => LoadDDSTexture(File.Open(filePath, FileMode.Open, FileAccess.Read), flipVertically);

//        /// <summary>
//        /// Loads a DDS texture from an input stream.
//        /// </summary>
//        public static TextureInfo LoadDDSTexture(Stream inputStream, bool flipVertically = false)
//        {
...
//                {
//                    var header2 = new DDS_HEADER_DXT10();
//                    header2.Read(r);
//                }
...
//        /// </summary>
//        static void ExtractDDSTextureFormatAndData(DDS_HEADER header, BinaryReader r, out bool hasMipmaps, out uint DDSMipmapLevelCount, out TextureFormat textureFormat, out int bytesPerPixel, out byte[] textureData)
//        {
...
//                    else textureData = new byte[TextureInfo.GetMipMappedTextureDataSize((int)header.dwWidth, (int)header.dwHeight, bytesPerPixel)];
