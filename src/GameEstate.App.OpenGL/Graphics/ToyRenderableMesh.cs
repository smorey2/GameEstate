...
namespace GameEstate.Graphics
{
    public class ToyRenderableMesh : RenderableMesh
    {
        ...
        public ToyRenderableMesh(IGLContext context, DATAMesh mesh, Dictionary<string, string> skinMaterials = null)
        {
            _context = context;
            _mesh = mesh;
        ...
        public void SetRenderMode(string renderMode)
        {
            ...
            foreach (var call in drawCalls)
            {
                ...
                call.Shader = _context.ShaderLoader.LoadShader(call.Shader.Name, parameters);
        ...
        void SetupDrawCalls(DATAMesh mesh, Dictionary<string, string> skinMaterials)
        {
            var vbib = mesh.VBIB;
            var data = mesh.Data;
            ...
            foreach (var sceneObject in sceneObjects)
            {
                ...
                foreach (var objectDrawCall in objectDrawCalls)
                {
                    ...
                    var material = _context.MaterialLoader.GetMaterial(materialName);
        ...
        DrawCall CreateDrawCall(IDictionary<string, object> objectDrawCall, VBIB vbib, IDictionary<string, bool> shaderArguments, RenderMaterial material)
        {
            ...
            // Load shader
            drawCall.Shader = _context.LoadShader(drawCall.Material.Data.ShaderName, combinedShaderParameters, Shader.ShaderKind.Normal);
