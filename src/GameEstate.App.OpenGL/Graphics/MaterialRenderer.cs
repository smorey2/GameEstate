...
namespace GameEstate.Graphics
{
    public class MaterialRenderer : IRenderer
    {
        ...
        public MaterialRenderer(IGLContext context, Material material)
        {
            _context = context;
            _material = material;
            _shader = _context.LoadShader(_material.Data.ShaderName, _material.Data.GetShaderArguments(), Shader.ShaderKind.Plane);
