...
namespace GameEstate.Graphics.Scene
{
    public class Scene
    {
        ...
        public void RenderWithCamera(Camera camera, Frustum cullFrustum = null)
        {
            ...
            Context.MeshBatchRenderer(opaqueDrawCalls, opaqueRenderContext);
            ...
            Context.MeshBatchRenderer(blendedDrawCalls, blendedRenderContext);
