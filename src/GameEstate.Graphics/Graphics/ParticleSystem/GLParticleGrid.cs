...
{
    public class GLParticleGrid : IRenderer
    {
        readonly int _vao;
        ...
        public GLParticleGrid(float cellWidth, int gridWidthInCells, IGLContext context)
        {
            ...
            _shader = context.LoadShader("vrf.grid", new Dictionary<string, bool>());
