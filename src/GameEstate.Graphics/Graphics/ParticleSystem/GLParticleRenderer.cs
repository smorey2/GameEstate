...
{
    public class GLParticleRenderer : IRenderer
    {
        ...
        void SetupRenderers(IEnumerable<IDictionary<string, object>> rendererData)
        {
            ...
            foreach (var rendererInfo in rendererData)
            {
                ...
                if (ParticleControllerFactory.TryCreateRender(rendererClass, rendererInfo, _context, out var renderer)) renderers.Add(renderer);
