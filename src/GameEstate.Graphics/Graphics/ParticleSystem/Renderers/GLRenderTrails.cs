...
{
    public class GLRenderTrails : IParticleRenderer
    {
        ...
        public GLRenderTrails(IDictionary<string, object> keyValues, IGLContext context)
        {
            _shader = context.LoadShader("vrf.particle.trail", new Dictionary<string, bool>());
