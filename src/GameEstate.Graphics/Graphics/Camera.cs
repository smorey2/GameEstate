...
namespace GameEstate.Graphics
{
    public abstract class Camera
    {
        ...
        protected const float FOV = OpenTK.MathHelper.PiOver4;
        ...
        protected Vector3 GetRightVector() => new Vector3((float)Math.Cos(Yaw - OpenTK.MathHelper.PiOver2), (float)Math.Sin(Yaw - OpenTK.MathHelper.PiOver2), 0);
