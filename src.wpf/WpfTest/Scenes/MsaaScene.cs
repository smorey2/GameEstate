...
namespace WpfTest.Scenes
{
    ...
    public class MsaaScene : WpfGame
    {
        ...
        RasterizerState _filled;
        TextComponent _msaaMessage;
        ...
        string GetMsaaMessage() => $"MSAA is {(_graphicsDeviceService.PreferMultiSampling ? "On" : "Off")}, press space to toggle";
        ...
        void DrawCubes(RasterizerState rasterizerState, Color color)
        {
