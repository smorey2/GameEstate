...
namespace WpfTest.Scenes
{
    ...
    {
        int _numberOfInitializeCalls;
        int _numberOfDisposeCalls;
        int _numberOfActivateCalls;
        int _numberOfDeactivateCalls;
        DateTime _lastActivateCall, _lastDeactivateCall;
        TextComponent _text;
        internal static int Counter;
        int _id;
        bool _lastIsActiveState;
        ...
        protected override void Initialize()
        {
            ...
            var parent = this.FindParent<Window>() as ILogToUi;
