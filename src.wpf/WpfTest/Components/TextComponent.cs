...
namespace WpfTest.Components
{
    ...
    public class TextComponent : WpfDrawableGameComponent
    {
        ...
        readonly HorizontalAlignment _h;
        readonly VerticalAlignment _v;
        SpriteFont _font;
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        static Vector2 RecomputePosition(Vector2 position, Vector2 size, HorizontalAlignment h, VerticalAlignment v)
        {
            switch (h)
            {
