...
namespace WpfTest.Renderer
{
    public class GLViewerControl : GLControl
    {
        ...
        protected override void OnMouseEnter(MouseEventArgs e) { Console.WriteLine("Enter"); Camera.MouseOver = true; }

        protected override void OnMouseLeave(MouseEventArgs e) { Console.WriteLine("Leave"); Camera.MouseOver = false; }
